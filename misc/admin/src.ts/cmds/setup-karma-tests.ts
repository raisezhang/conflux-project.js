...
(async function() {
    ...
    copy(resolve("packages/conflux/dist/ethers.esm.js"), resolve("output/karma/ethers.esm.js"));
    ...
    copy(resolve("packages/conflux/dist/ethers.umd.js"), resolve("output/karma/ethers.umd.js"));
