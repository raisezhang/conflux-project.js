...
var logger = new conflux_1.ethers.utils.Logger(_version_1.version);
...
var WrappedSigner = /** @class */ (function (_super) {
    ...
    function WrappedSigner(addressPromise, signerFunc, plugin) {
        ...
        conflux_1.ethers.utils.defineReadOnly(_this, "addressPromise", addressPromise);
        conflux_1.ethers.utils.defineReadOnly(_this, "provider", plugin.provider);
        conflux_1.ethers.utils.defineReadOnly(_this, "plugin", plugin);
        return _this;
    }
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (typeof (message) === "string") {
                            ...
                            info["Message (hex)"] = conflux_1.ethers.utils.hexlify(conflux_1.ethers.utils.toUtf8Bytes(message));
                        }
                        else {
                            bytes = conflux_1.ethers.utils.arrayify(message);
                            ...
                            if (bytes) {
                                info["Message"] = conflux_1.ethers.utils.toUtf8String(bytes);
                            }
                            info["Message (hex)"] = conflux_1.ethers.utils.hexlify(message);
                        }
                        dump("Message:", info);
                    ...
                    case 3:
                        result = _a.sent();
                        signature = conflux_1.ethers.utils.splitSignature(result);
                        dump("Signature", {
                            Flat: result,
                            r: signature.r,
                            s: signature.s,
    ...
    WrappedSigner.prototype.populateTransaction = function (transactionRequest) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        transactionRequest = conflux_1.ethers.utils.shallowCopy(transactionRequest);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        network = _a.sent();
                        return [4 /*yield*/, conflux_1.ethers.utils.resolveProperties(transactionRequest)];
                    case 3:
                        tx = _a.sent();
                        info = {};
                        if (tx.to != null) {
                        ...
                        info["Value"] = (conflux_1.ethers.utils.formatEther(tx.value || 0) + " ether");
                        if (tx.nonce != null) {
                            info["Nonce"] = tx.nonce;
                        }
                        info["Data"] = tx.data;
                        info["Gas Limit"] = conflux_1.ethers.BigNumber.from(tx.gasLimit || 0).toString();
                        info["Gas Price"] = (conflux_1.ethers.utils.formatUnits(tx.gasPrice || 0, "gwei") + " gwei"),
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        tx = _a.sent();
                        return [4 /*yield*/, conflux_1.ethers.utils.resolveProperties(tx)];
                    case 4:
                        tx = _a.sent();
                        info = {};
                        if (tx.to != null) {
                    ...
                    case 8:
                        ...
                        dump("Success:", {
                            ...
                            "Gas Used": conflux_1.ethers.utils.commify(receipt.gasUsed.toString()),
                            "Fee": (conflux_1.ethers.utils.formatEther(receipt.gasUsed.mul(tx.gasPrice)) + " ether")
                        });
                        return [3 /*break*/, 10];
                    case 9:
                        error_2 = _a.sent();
...
var OfflineProvider = /** @class */ (function (_super) {
    ...
    OfflineProvider.prototype.perform = function (method, params) {
        if (method === "sendTransaction") {
            ...
            return Promise.resolve(conflux_1.ethers.utils.keccak256(params.signedTransaction));
        }
        return _super.prototype.perform.call(this, method, params);
    };
    return OfflineProvider;
}(conflux_1.ethers.providers.BaseProvider));
/////////////////////////////
// Argument Parser
var ArgParser = /** @class */ (function () {
    function ArgParser(args) {
        conflux_1.ethers.utils.defineReadOnly(this, "_args", args);
        conflux_1.ethers.utils.defineReadOnly(this, "_consumed", args.map(function (a) { return false; }));
    }
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    // Raw private key
                    if (conflux_1.ethers.utils.isHexString(arg, 32)) {
                        signer_1 = new conflux_1.ethers.Wallet(arg, plugin.provider);
                        return [2 /*return*/, Promise.resolve(new WrappedSigner(signer_1.getAddress(), function () { return Promise.resolve(signer_1); }, plugin))];
                    }
                    // Mnemonic
                    if (conflux_1.ethers.utils.isValidMnemonic(arg)) {
                        mnemonic_1 = arg;
                        ...
                        if (plugin.mnemonicPassword) {
                            signerPromise_1 = prompt_1.getPassword("Password (mnemonic): ").then(function (password) {
                                var node = conflux_1.ethers.utils.HDNode.fromMnemonic(mnemonic_1, password).derivePath(conflux_1.ethers.utils.defaultPath);
                                return new conflux_1.ethers.Wallet(node.privateKey, plugin.provider);
                            });
                        }
                            ...
                            signerPromise_1 = prompt_1.getPassword("Password (mnemonic; experimental - hard): ").then(function (password) {
                                var passwordBytes = conflux_1.ethers.utils.toUtf8Bytes(password, conflux_1.ethers.utils.UnicodeNormalizationForm.NFKC);
                                var saltBytes = conflux_1.ethers.utils.arrayify(conflux_1.ethers.utils.HDNode.fromMnemonic(mnemonic_1).privateKey);
                                ...
                                return scrypt.scrypt(passwordBytes, saltBytes, (1 << 20), 8, 1, 32, progressBar).then(function (key) {
                                    var derivedPassword = conflux_1.ethers.utils.hexlify(key).substring(2);
                                    var node = conflux_1.ethers.utils.HDNode.fromMnemonic(mnemonic_1, derivedPassword).derivePath(conflux_1.ethers.utils.defaultPath);
                                    return new conflux_1.ethers.Wallet(node.privateKey, plugin.provider);
                                });
                            });
                        }
                        else {
                            signerPromise_1 = Promise.resolve(conflux_1.ethers.Wallet.fromMnemonic(arg).connect(plugin.provider));
                        }
                    ...
                    try {
                        ...
                        address = conflux_1.ethers.utils.getJsonWalletAddress(content_1);
                        if (address) {
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 1:
                                                ...
                                                return [2 /*return*/, conflux_1.ethers.Wallet.fromEncryptedJson(content_1, password, progressBar).then(function (wallet) {
...
var Plugin = /** @class */ (function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        argParser.consumeOptions("rpc").forEach(function (url) {
                            var provider = new conflux_1.ethers.providers.JsonRpcProvider(url);
                            providers.push(provider);
                            rpc.push(provider);
                        });
                        if (argParser.consumeFlag("alchemy")) {
                            providers.push(new conflux_1.ethers.providers.AlchemyProvider(network));
                        }
                        if (argParser.consumeFlag("etherscan")) {
                            providers.push(new conflux_1.ethers.providers.EtherscanProvider(network));
                        }
                        if (argParser.consumeFlag("infura")) {
                            providers.push(new conflux_1.ethers.providers.InfuraProvider(network));
                        }
                        if (argParser.consumeFlag("nodesmith")) {
                            providers.push(new conflux_1.ethers.providers.NodesmithProvider(network));
                        }
                        if (argParser.consumeFlag("offline")) {
                            providers.push(new OfflineProvider(network));
                        }
                        if (providers.length === 1) {
                            conflux_1.ethers.utils.defineReadOnly(this, "provider", providers[0]);
                        }
                        else if (providers.length) {
                            conflux_1.ethers.utils.defineReadOnly(this, "provider", new conflux_1.ethers.providers.FallbackProvider(providers));
                        }
                        else {
                            conflux_1.ethers.utils.defineReadOnly(this, "provider", conflux_1.ethers.getDefaultProvider(network));
                        }
                        /////////////////////
                        // Accounts
                        conflux_1.ethers.utils.defineReadOnly(this, "mnemonicPassword", argParser.consumeFlag("mnemonic-password"));
                        conflux_1.ethers.utils.defineReadOnly(this, "_xxxMnemonicPasswordHard", argParser.consumeFlag("xxx-mnemonic-password"));
                        accounts = [];
                                    ...
                                    case 3:
                                        ...
                                        try {
                                            ...
                                            if (account.value.match(/^[0-9]+$/)) {
                                                ...
                                                signer_2 = rpc[0].getSigner(conflux_1.ethers.utils.getAddress(account.value));
                                            }
                                    ...
                                    case 4:
                                        {
                                            ...
                                            signerPromise_2 = addressPromise.then(function (addr) {
                                                return new conflux_1.ethers.VoidSigner(addr, _this.provider);
                                            });
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 1];
                    case 4:
                        conflux_1.ethers.utils.defineReadOnly(this, "accounts", Object.freeze(accounts));
                        gasPrice = argParser.consumeOption("gas-price");
                        if (gasPrice) {
                            conflux_1.ethers.utils.defineReadOnly(this, "gasPrice", conflux_1.ethers.utils.parseUnits(gasPrice, "gwei"));
                        }
                        else {
                            conflux_1.ethers.utils.defineReadOnly(this, "gasPrice", null);
                        }
                        gasLimit = argParser.consumeOption("gas-limit");
                        if (gasLimit) {
                            conflux_1.ethers.utils.defineReadOnly(this, "gasLimit", conflux_1.ethers.BigNumber.from(gasLimit));
                        }
                        else {
                            conflux_1.ethers.utils.defineReadOnly(this, "gasLimit", null);
                        }
                        nonce = argParser.consumeOption("nonce");
                        if (nonce) {
                            this.nonce = conflux_1.ethers.BigNumber.from(nonce).toNumber();
                        }
                        // Now wait for all asynchronous options to load
                        runners.push(this.provider.getNetwork().then(function (network) {
                            conflux_1.ethers.utils.defineReadOnly(_this, "network", Object.freeze(network));
                        }, function (error) {
                            conflux_1.ethers.utils.defineReadOnly(_this, "network", Object.freeze({
                                chainId: 0,
                                name: "no-network"
                            }));
                        }));
    ...
    Plugin.prototype.getAddress = function (addressOrName, message, allowZero) {
        var _this = this;
        try {
            return Promise.resolve(conflux_1.ethers.utils.getAddress(addressOrName));
        }
        catch (error) { }
        return this.provider.resolveName(addressOrName).then(function (address) {
            ...
            if (address === conflux_1.ethers.constants.AddressZero && !allowZero) {
...
var CLI = /** @class */ (function () {
    function CLI(defaultCommand, options) {
        var _this = this;
        conflux_1.ethers.utils.defineReadOnly(this, "options", {
            account: true,
            provider: true,
            transaction: true,
        ...
        conflux_1.ethers.utils.defineReadOnly(this, "defaultCommand", defaultCommand || null);
        conflux_1.ethers.utils.defineReadOnly(this, "plugins", {});
    }
    ...
    CLI.prototype.addPlugin = function (command, plugin) {
        if (this.standAlone) {
            logger.throwError("only setPlugin or addPlugin may be used at once", conflux_1.ethers.errors.UNSUPPORTED_OPERATION, {
                operation: "addPlugin"
            });
        }
        else if (this.plugins[command]) {
            logger.throwError("command already exists", conflux_1.ethers.errors.UNSUPPORTED_OPERATION, {
                operation: "addPlugin",
                command: command
            });
        }
        conflux_1.ethers.utils.defineReadOnly(this.plugins, command, plugin);
    };
    CLI.prototype.setPlugin = function (plugin) {
        ...
        if (this.standAlone) {
            logger.throwError("cannot setPlugin more than once", conflux_1.ethers.errors.UNSUPPORTED_OPERATION, {
                operation: "setPlugin"
            });
        }
        conflux_1.ethers.utils.defineReadOnly(this, "standAlone", plugin);
    };
    CLI.prototype.showUsage = function (message, status) {
        // Limit:    |                                                                             |
        console.log("Usage:");
        if (this.standAlone) {
            var help = conflux_1.ethers.utils.getStatic(this.standAlone, "getHelp")();
            console.log("   " + CLI.getAppName() + " " + help.name + " [ OPTIONS ]");
            console.log("");
            var lines_1 = [];
            var optionHelp = conflux_1.ethers.utils.getStatic(this.standAlone, "getOptionHelp")();
            ...
            for (var cmd in this.plugins) {
                ...
                var help = conflux_1.ethers.utils.getStatic(plugin, "getHelp")();
                if (help == null) {
                    continue;
                }
                ...
                var optionHelp = conflux_1.ethers.utils.getStatic(plugin, "getOptionHelp")();
                optionHelp.forEach(function (help) {
