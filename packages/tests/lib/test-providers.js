...
function equals(name, actual, expected) {
    if (expected && expected.eq) {
        ...
        expected = conflux_1.ethers.BigNumber.from(expected);
        actual = conflux_1.ethers.BigNumber.from(actual);
...
var providerFunctions = [
    {
        ...
        create: function (network) {
            if (network == "default") {
                return conflux_1.ethers.getDefaultProvider(null, ApiKeys);
            }
            return conflux_1.ethers.getDefaultProvider(network, ApiKeys);
        }
    },
    {
        ...
        create: function (network) {
            if (network == "default") {
                return new conflux_1.ethers.providers.AlchemyProvider(null, ApiKeys.alchemy);
            }
            return new conflux_1.ethers.providers.AlchemyProvider(network, ApiKeys.alchemy);
        }
    },
    /*
    {
    ...
    */
    {
        ...
        create: function (network) {
            if (network == "default") {
                return new conflux_1.ethers.providers.InfuraProvider(null, ApiKeys.infura);
            }
            return new conflux_1.ethers.providers.InfuraProvider(network, ApiKeys.infura);
        }
    },
    {
        ...
        create: function (network) {
            if (network == "default") {
                return new conflux_1.ethers.providers.EtherscanProvider(null, ApiKeys.etherscan);
            }
            return new conflux_1.ethers.providers.EtherscanProvider(network, ApiKeys.etherscan);
        }
    },
    {
    ...
    },
    {
        ...
        create: function (network) {
            if (network == "default") {
                return new conflux_1.ethers.providers.PocketProvider(null, ApiKeys.pocket);
            }
            return new conflux_1.ethers.providers.PocketProvider(network, ApiKeys.pocket);
        }
    },
    {
        name: "Web3Provider",
...
var fundWallet = conflux_1.ethers.Wallet.createRandom();
var testFunctions = [];
...
(function () {
    ...
    addErrorTest(conflux_1.ethers.utils.Logger.errors.NONCE_EXPIRED, function (provider) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    addErrorTest(conflux_1.ethers.utils.Logger.errors.INSUFFICIENT_FUNDS, function (provider) { return __awaiter(_this, void 0, void 0, function () {
    ...
    addErrorTest(conflux_1.ethers.utils.Logger.errors.INSUFFICIENT_FUNDS, function (provider) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            wallet = conflux_1.ethers.Wallet.createRandom().connect(provider);
            return [2 /*return*/, wallet.sendTransaction(txProps)];
        });
    }); });
    addErrorTest(conflux_1.ethers.utils.Logger.errors.UNPREDICTABLE_GAS_LIMIT, function (provider) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    execute: function (provider) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    b0 = _a.sent();
                    assert_1.default.ok(b0.gt(conflux_1.ethers.constants.Zero), "balance is non-zero");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.timeout(300000);
                        provider = new conflux_1.ethers.providers.InfuraProvider("ropsten", ApiKeys.infura);
                        return [4 /*yield*/, conflux_1.ethers.utils.fetchJson("https://api.ethers.io/api/v1/?action=fundAccount&address=" + fundWallet.address.toLowerCase())];
                    case 1:
                        funder = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        provider = new conflux_1.ethers.providers.EtherscanProvider(null, ApiKeys.etherscan);
...
describe("Test Basic Authentication", function () {
    ...
    function test(name, url) {
        it("tests " + name, function () {
            this.timeout(60000);
            return conflux_1.ethers.utils.fetchJson(url).then(function (data) {
    ...
    it("tests insecure connections fail", function () {
        ...
        assert_1.default.throws(function () {
            return conflux_1.ethers.utils.fetchJson(insecure);
        }, function (error) {
...
describe("Test API Key Formatting", function () {
    it("Infura API Key", function () {
        ...
        var apiKeyString = conflux_1.ethers.providers.InfuraProvider.getApiKey(projectId);
        ...
        var apiKeyObject = conflux_1.ethers.providers.InfuraProvider.getApiKey({
            projectId: projectId
        });
        ...
        var apiKeyObject2 = conflux_1.ethers.providers.InfuraProvider.getApiKey({
            projectId: projectId,
        ...
        assert_1.default.throws(function () {
            var apiKey = conflux_1.ethers.providers.InfuraProvider.getApiKey({
                projectId: 1234,
                projectSecret: projectSecret
            });
            console.log(apiKey);
        ...
        {
            var provider = new conflux_1.ethers.providers.InfuraProvider("homestead", {
                projectId: projectId,
                projectSecret: projectSecret
            });
        ...
        assert_1.default.throws(function () {
            var provider = new conflux_1.ethers.providers.InfuraProvider("imaginary");
    ...
    it("Pocket API key", function () {
        ...
        var apiKeyString = conflux_1.ethers.providers.PocketProvider.getApiKey(applicationId);
        ...
        var apiKeyObject = conflux_1.ethers.providers.PocketProvider.getApiKey({
        ...
        var apiKeyObject2 = conflux_1.ethers.providers.PocketProvider.getApiKey({
            applicationId: applicationId,
        ...
        assert_1.default.throws(function () {
            var apiKey = conflux_1.ethers.providers.PocketProvider.getApiKey({
                applicationId: 1234,
                applicationSecretKey: applicationSecretKey
            });
            console.log(apiKey);
        ...
        {
            var provider = new conflux_1.ethers.providers.PocketProvider("homestead", {
                applicationId: applicationId,
                applicationSecretKey: applicationSecretKey
            });
            assert_1.default.equal(provider.network.name, "homestead");
        ...
        // Attempt an unsupported network
        assert_1.default.throws(function () {
            var provider = new conflux_1.ethers.providers.PocketProvider("imaginary");
            console.log(provider);
        }, function (error) {
            return (error.argument === "network" && error.reason === "unsupported network");
        });
    ...
    it("InfuraProvider.getWebSocketProvider", function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        provider = conflux_1.ethers.providers.InfuraProvider.getWebSocketProvider();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.timeout(60000);
                        provider = new conflux_1.ethers.providers.InfuraProvider("rinkeby");
