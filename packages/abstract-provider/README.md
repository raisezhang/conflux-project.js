...
For signing, see the [Abstract Signer](https://www.npmjs.com/package/@confluxproject/abstract-signer)
or [Wallet](https://www.npmjs.com/package/@confluxproject/wallet) sub-modules.
...
} = require("@confluxproject/abstract-provider");
```
