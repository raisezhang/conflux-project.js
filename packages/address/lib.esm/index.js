"use strict";
import { arrayify, concat, hexDataLength, hexDataSlice, isHexString, stripZeros } from "@confluxproject/bytes";
import { BigNumber, _base16To36, _base36To16 } from "@confluxproject/bignumber";
...
export function isLikeHex40Address(address) {
    return /^0x[0-9a-fA-F]{40}$/.test(address);
}
export function isLikeBase32Address(address) {
...
export function getBase32AddressFromHex40(address, chainId) {
...
export function getHex40AddressFromBase32(address) {
